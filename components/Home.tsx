    ...
    <button className="w-full bg-gradient-to-r from-yellow-500/30 to-orange-500/30 backdrop-blur-sm text-yellow-50 font-bold py-3 px-4 rounded-xl border border-yellow-300/40 transition-all duration-200 hover:from-yellow-400/40 hover:to-orange-400/40 hover:border-yellow-200/60 hover:shadow-lg">
      Explore Men's Health
          ...
          <div className="lg:col-span-6">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-green-800 mb-2">Featured Products</h2>
              <p className="text-green-600">Discover our premium Ayurvedic formulations</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {products.map((product) => (
                <div key={product.id} className="bg-white border-2 border-green-100 rounded-2xl shadow-lg overflow-hidden transition-shadow duration-300 hover:shadow-xl">
                  <div className="relative overflow-hidden">
                    ...
                    />
                    <div className="absolute top-3 left-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white px-3 py-1 rounded-full text-sm font-bold shadow-lg">
                      {product.id}
                    </div>
                    <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full flex items-center space-x-1">
                      ...
                      <span className="text-sm font-bold text-green-800">{product.rating}</span>
                    </div>
                  </div>
                  <div className="p-6">
                    <h3 className="font-bold text-green-800 mb-2 text-lg">{product.name}</h3>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button className="bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-xl flex items-center space-x-2 shadow-lg font-medium transition-colors duration-200 hover:from-green-700 hover:to-emerald-700">
